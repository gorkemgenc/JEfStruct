...
public class jEfArrayModifierTest extends TestCase {

    @Test
    public void testIntArray() {
        Integer[] array = new Integer[]{1,2,3,4,5};
        int[] intArray = jEfArrayModifier.intArray(array);
    ...
    public void testDoubleArray() {
        ...
        double[] doubleArray = jEfArrayModifier.doubleArray(array);
    ...
    public void testFloatArray() {
        ...
        float[] floatArray = jEfArrayModifier.floatArray(array);
    ...
    public void testLongArray() {
        ...
        long[] longArray = jEfArrayModifier.longArray(array);
    ...
    public void testArrayNullException(){
        try {
            jEfArrayModifier.intArray(null);
            fail( "Array is null" );
        }
