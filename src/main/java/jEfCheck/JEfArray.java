...
public class JEfArray<T> {
     ...
     * @return boolean
     */
    public static <T> boolean hasUniqueElement(T[] array) throws JEfArrayNullException {
     ...
     * @return boolean
     */
    public static <T> boolean isArraysSame(List<T[]> list) throws JEfListNullException {
